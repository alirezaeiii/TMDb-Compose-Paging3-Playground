...
) : BaseRepository<List<TVShow>, Nothing>(context, ioDispatcher) {
    override suspend fun getSuccessResult(id: Nothing?): List<TVShow> = tvShowDao.getBookmarks().asDomainModel()
}
